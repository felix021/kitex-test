...
func (p *TestServiceClient) Echo(ctx context.Context, req *EchoRequest) (r *EchoResponse, err error) {
	var _args TestServiceEchoArgs
	_args.Req = req
	var _result TestServiceEchoResult
...
func (p *TestServiceEchoArgs) Field1DeepEqual(src *EchoRequest) bool {
...
func (p *TestServiceEchoResult) Field0DeepEqual(src *EchoResponse) bool {
